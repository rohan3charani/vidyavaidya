      ...
      <div className="hero-right">
        ...
        <div className="logo-container">
          <div className="logo-card">
            <img 
              src="src/assets/Vidya.png" 
              alt="Vidya Vaidya Foundation" 
              className="hero-logo"
            />
            <h2 className="logo-title">VIDYA-VAIDYA</h2>
            <p className="logo-subtitle">FOUNDATION</p>
            <div className="logo-divider" />
            <p className="logo-tagline">Knowledge | Care | Dignity</p>
          </div>
        </div>
      </div>
    </section>

...
//           stroke="#ffffff" strokeWidth="2.4" strokeLinejoin="round"
//         />
...
//               <h4 className="wow fadeInUp" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
//                 Non - Profit Charity
//               </h4>
//               <h1 className="wow fadeInUp" data-wow-delay=".3s" style={{ visibility: 'visible', animationDelay: '0.3s', animationName: 'fadeInUp' }}>
//                 Make Someone’s <br />Life By Giving Of <br />Yours's.
//               </h1>
//               <div className="hero-button-item wow fadeInUp" data-wow-delay=".5s" style={{ visibility: 'visible', animationDelay: '0.5s', animationName: 'fadeInUp' }}>
//                 <a href="#contact" className="theme-btn border-btn solid-yellow-btn">
//                   Join With Us &#x2197;
//                 </a>
//                 <span className="button-text">
//                   <a href="https://www.youtube.com/watch?v=Cn4G2lZ_g2I" className="video-btn ripple video-popup" target="_blank" rel="noopener noreferrer">
//                     <i className="fa-solid fa-play play-icon-small"></i>
//                   </a>
//                   <span className="ms-3 video-text">Video Playing Theme</span>
//                 </span>
//               </div>
//             </div>
//           </div>
...
// /* ─── Named export: What We Do section ─── */
...
//   return (
//     <section
//       className={`svc-section ${svcVisible ? "svc-visible" : ""}`}
//       ref={svcRef}
//       id="services"
//     >
...
//   return (
//     <section
//       className={`cta-banner ${ctaVisible ? "cta-visible" : ""}`}
//       ref={ctaRef}
//       id="cta"
//     >
...
//             <path d="M22 38S6 28 6 16a10 10 0 0 1 16-8 10 10 0 0 1 16 8c0 12-16 22-16 22Z"
...
//           Join the Community of Over a{" "}
//           <span className="cta-heading-accent">Million</span> People
//         </h2>

//         <p className="cta-desc">
//           Together we create lasting change — one life, one community, one future at a time.
...
//               width="17" height="17" aria-hidden="true" className="cta-btn-icon">
//               <path d="M10 2a2 2 0 0 0-2 2v6.5l-1.2-.6a1.5 1.5 0 0 0-2 2l2.5 1.3V16a2 2 0 0 0 2 2h3a2 2 0 0 0 2-2v-5.6l.5-.4a2 2 0 0 0 .5-1.4V4a2 2 0 0 0-2-2h-3Z"
//                 fill="white"/>
//             </svg>
//             Become A Donor
...
//           {[
//             { num: "120K+", label: "Volunteers" },
//             { num: "$4.2M", label: "Raised" },
//             { num: "80+",   label: "Countries" },
//           ].map(({ num, label }) => (
//             <div className="cta-trust-item" key={label}>
//               <strong>{num}</strong>
//               <span>{label}</span>
//             </div>
//           ))}
...
//     socials: { twitter: "#", whatsapp: "#", instagram: "#", telegram: "#" },
//   },
//   {
//     id: "t2",
//     name: "Daniel Carter",
...
//           <span className="team-badge-dot" aria-hidden="true" />
//           TEAM MEMBERS
//         </div>
//         <h2 className="team-heading">
//           Meet the optimistic <span className="team-heading-accent">volunteer</span>
//         </h2>
//         <p className="team-subtext">
//           Passionate individuals working every day to bring hope,
//           dignity, and opportunity to communities around the world.
//         </p>
//       </div>

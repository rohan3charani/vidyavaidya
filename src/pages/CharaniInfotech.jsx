...
export default function CharaniInfotech() {
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-24 px-6 lg:px-20 overflow-hidden bg-gradient-to-br from-green-600 via-teal-700 to-blue-900 text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            <span className="inline-flex rounded-full bg-emerald-500/30 px-4 py-2 text-sm font-semibold uppercase tracking-[0.24em] text-emerald-200 mb-6">
              Official Tech Partner
            </span>
            <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">CHARANI INFOTECH</h1>
            <p className="text-xl text-emerald-200 font-medium mb-6">Led by CEO G.Rajsekhar</p>
      ...
      <section className="py-20 px-6 lg:px-20 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          <svg className="w-16 h-16 mx-auto text-emerald-400 mb-6 opacity-30" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center justify-center mt-10">
            <img src={RajsekharImg} alt="CEO G.Rajsekhar" className="w-24 h-24 rounded-full object-cover mb-4 shadow-lg border-4 border-emerald-50" />
            <p className="text-xl font-bold text-slate-900">G. Rajsekhar</p>
            <p className="text-teal-600 font-semibold uppercase tracking-wider text-sm mt-1">CEO, Charani Infotech</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-200 bg-white">
              <div className="relative overflow-hidden aspect-[4/3] bg-slate-100 flex items-center justify-center">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/80 via-emerald-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                  <p className="text-white font-bold text-2xl mb-2">Innovative Workspace</p>
                  <p className="text-emerald-200 font-medium">Where technology meets social impact.</p>
                </div>
              </div>
            </div>
            <div className="group rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-200 bg-white">
              <div className="relative overflow-hidden aspect-[4/3] bg-slate-100 flex items-center justify-center">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/80 via-emerald-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                  ...
                  <p className="text-emerald-200 font-medium">A trusted name in IT solutions.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6 bg-slate-900 text-center text-white">
        ...
        <p className="text-emerald-200 max-w-2xl mx-auto text-lg mb-10">We are always looking for passionate corporate sponsors to empower communities through technology.</p>
        <Link to="/join-community" className="inline-block bg-emerald-500 text-white font-bold px-8 py-4 rounded-full hover:bg-emerald-400 hover:scale-105 transition-all shadow-xl">
          Become a Sponsor
        </Link>
      </section>

  ...
  return (
    <div className="page-wrapper">
      ...
      <section className="page-hero">
        ...
        <h1>Our Mission</h1>
        <p>VidyaVaidya is dedicated to transforming lives through holistic interventions in education and healthcare. We envision a world where every individual has the opportunity to thrive.</p>
      </section>
